...
const buttonVariants = cva(
  'flex items-center justify-center rounded-md ring-1 px-4 py-2 font-medium transition-all duration-200 outline-none ease-in-out focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95',
  {
    variants: {
      variant: {
        default:
